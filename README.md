...
Weather.vue gives a breif report on the weather in the local area.
...
3. run the command “npm install” to install all of the project dependancies
4. Create .env file
5. Run refreshWeather.sh 
6. Run cors_proxy.js
7. Run gridengine.js
8. Run server with npm run serve (usually goes to localhost://8080) 